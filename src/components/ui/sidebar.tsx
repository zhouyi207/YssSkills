...
function SidebarTrigger({
  ...
  return (
    <Button
      ...
      {...props}
    >
      {children ?? <RiSideBarLine aria-hidden="true" />}
...
function SidebarInset({ className, ...props }: React.ComponentProps<"main">) {
  return (
    <main
      ...
      className={cn(
        "relative flex min-h-0 min-w-0 w-full flex-1 flex-col overflow-x-hidden bg-background md:peer-data-[variant=inset]:rounded-none",
        className,
      )}
      {...props}
    />
